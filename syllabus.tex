...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, bottomtitle=1mm, opacityback=0, colback=white, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, left=2mm, breakable, arc=.35mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{A note on quizzes}, bottomrule=.15mm, opacitybacktitle=0.6, coltitle=black, toprule=.15mm, leftrule=.75mm, colframe=quarto-callout-note-color-frame]
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, bottomtitle=1mm, opacityback=0, colback=white, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, left=2mm, breakable, arc=.35mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{A note on exams}, bottomrule=.15mm, opacitybacktitle=0.6, coltitle=black, toprule=.15mm, leftrule=.75mm, colframe=quarto-callout-note-color-frame]
